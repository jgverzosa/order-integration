...
class DietaryLabel(Schema):
    class Meta:
        unknown = EXCLUDE
    labels = fields.List(fields.String(), load_default=[], missing=[])

class DietaryLabelInfo(Schema):
    class Meta:
        unknown = EXCLUDE
    dietary_label_info = fields.Nested(DietaryLabel, missing=None)
...
class Quantity(Schema):
    class Meta:
        unknown = EXCLUDE
    min_permitted = fields.Integer(missing=None)
    max_permitted = fields.Integer(missing=None)
...
class DisplayOptions(Schema):
    class Meta:
        unknown = EXCLUDE
    disable_item_instructions = fields.Boolean()
